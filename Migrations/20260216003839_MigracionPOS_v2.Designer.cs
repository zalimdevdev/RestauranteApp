...
namespace RestauranteApp.Migrations
{
    ...
    [Migration("20260216003839_MigracionPOS_v2")]
    partial class MigracionPOS_v2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RestauranteApp.Models.DetalleOrden", b =>
                {
                    ...
                    b.Property<bool>("EstaServido")
                        .HasColumnType("boolean");

                    b.Property<DateTime?>("FechaHoraServido")
                        .HasColumnType("timestamp without time zone");
            ...
            modelBuilder.Entity("RestauranteApp.Models.Mesa", b =>
                {
                    ...
                    b.Property<string>("EstadoReservacion")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)");
            ...
            modelBuilder.Entity("RestauranteApp.Models.Orden", b =>
                {
                    b.Property<int>("OrdenId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("RestauranteApp.Models.DetalleOrden", b =>
                {
                    ...
                    b.HasOne("RestauranteApp.Models.Orden", "Orden")
                        .WithMany("Detalles")
            ...
            modelBuilder.Entity("RestauranteApp.Models.Factura", b =>
                {
                    ...
                    b.HasOne("RestauranteApp.Models.Cliente", null)
                        .WithMany("Facturas")
                    ...
                    b.HasOne("RestauranteApp.Models.Orden", "Orden")
                        .WithOne("Factura")
                        .HasForeignKey("RestauranteApp.Models.Factura", "OrdenId")
                        .OnDelete(DeleteBehavior.Restrict);
