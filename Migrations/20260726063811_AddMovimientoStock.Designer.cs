...
namespace RestauranteApp.Migrations
{
    ...
    [Migration("20260726063811_AddMovimientoStock")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RestauranteApp.Models.BackupRegistro", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("RestauranteApp.Models.Ingrediente", b =>
                {
                    ...
                    b.Property<DateTime?>("FechaStockInicial")
                        .HasColumnType("timestamp without time zone");
            ...
            modelBuilder.Entity("RestauranteApp.Models.MovimientoStock", b =>
                {
            ...
            modelBuilder.Entity("RestauranteApp.Models.MovimientoStock", b =>
                {
                    b.HasOne("RestauranteApp.Models.DetalleFactura", "DetalleFactura")
                        .WithMany()
